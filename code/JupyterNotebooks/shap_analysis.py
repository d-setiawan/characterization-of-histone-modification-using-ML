...
function_map = {
    ...
    "Known Function": ['Activating', 'Repressive', 'Activating', 'Activating', 'Activating',
                       ...
                       'Repressive', 'Repressive', 'Activating', 'Activating', 'Unknown']}
...
class SHAPAnalyzer:
    ...
    def calculate_high_value_shap_means(self):
        ...
        results_df['Function Value'] = results_df['Known Function'].map({'Activating': 1, 'Repressive': -1}).fillna(0)
    ...
    def compare_shap_function(row):
        ...
        ## Put it so that it will say activating or repressive in the return statement for unknown functions
        if row["Known Function"] not in ["Activating", "Repressive"]:
